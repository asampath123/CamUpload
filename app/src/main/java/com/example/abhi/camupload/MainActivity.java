package com.example.abhi.camupload;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btpic, btnup;
    String ba1;
    public static String URL = "http://192.168.56.1:80/testProject/hello.php";
    //public static String URL = "http://129.79.247.5:15000/todo/api/v1.0/tasks";
